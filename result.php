            ...
            <div class="col-lg-6 col-lg-push-3" style="min-height: 500px; background-color: white;">
            	...
            	if($correct>=$count/2)
            	{
					...
					<script type="text/javascript">
						window.location.href="indexcert.php";
					</script>
					<?php            	
            	...
            	else
            	{
            		?>
            		<script type="text/javascript">
            			alert("Sorry you have not cleared the exam");
...
<?php
	...
	{
		$date=date("Y-m-d");
		mysqli_query($link,"insert into exam_results(username,exam_type,total_question,correct_answer,wrong_answer,exam_time) 
			values ('$_SESSION[username]','$_SESSION[exam_category]','$count','$correct','$wrong','$date')") or die(mysqli_error($link));
	}
