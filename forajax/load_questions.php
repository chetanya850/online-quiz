...
//$p="select * FROM questions WHERE id=(select max(id) FROM questions) && category='$_SESSION[exam_category]'";
	...
	<table style="margin-left: 10px; margin-top: 20px; margin-bottom: 5px;">
		<tr>
			...
			<td style="padding-left: 10px">
				...
				{
					?>
					<img src="admin/<?php echo $opt1; ?>" height="100" width="100">
					<?php
				}
				else
				{
...
?>
		...
		<tr>
			...
			<td style="padding-left: 10px">
				...
				{
					?>
					<img src="admin/<?php echo $opt2; ?>" height="100" width="100">
					<?php
				}
				else
				{
...
?>
		...
		<tr>
			<td>
				<input type="radio" name="r1" id="r1" value="<?php echo $opt3;?>" onclick="radioclick(this.value,<?php echo 
					$question_no; ?>)"					
				<?php
				if($ans==$opt3)
				{
			...
			<td style="padding-left: 10px">
				...
				{
					?>
					<img src="admin/<?php echo $opt3; ?>" height="100" width="100">
					<?php
				}
				else
				{
...
?>
		...
		<tr>
			...
			<td style="padding-left: 10px">
				...
				{
					?>
					<img src="admin/<?php echo $opt4; ?>" height="100" width="100">
					<?php
				}
				else
				{
