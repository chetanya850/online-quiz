            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Edit Questions with images</h1>
                    </div>
                </div>
            </div>
 					...
 					<div class="col-lg-12">
									...
									<div class="card">
										<div class="card-header"><strong>Add new questions</strong></div>
											...
											<input type="text" id="company" placeholder="Enter question here" class="form-control" value="<?php echo $question; ?>" name="fquestion">
											</div>
...
if(isset($_POST["submit2"]))
{
	...
	move_uploaded_file($_FILES["fopt3"]["tmp_name"],$dst1);		
