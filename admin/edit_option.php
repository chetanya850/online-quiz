							  ...
							  <div class="col-lg-12">
									...
									<div class="card">
										<div class="card-header"><strong>Update Question with text</strong></div>
											...
											<input type="text" id="company" placeholder="Enter question here" class="form-control" name="question" value="<?php echo $question; ?>">
											</div>
											
											<div class="form-group">
											<label for="company" class=" form-control-label">Option 1</label>
											<input type="text" id="company" placeholder="Enter opt 1" class="form-control" name="opt1" value="<?php echo $opt1; ?>">
											</div>
											
											<div class="form-group">
											<label for="company" class=" form-control-label">Option 2</label>
											<input type="text" id="company" placeholder="Enter opt 2" class="form-control" name="opt2" value="<?php echo $opt2; ?>">
											</div>
											
											<div class="form-group">
											<label for="company" class=" form-control-label">Option 3</label>
											<input type="text" id="company" placeholder="Enter opt 3" class="form-control" name="opt3" value="<?php echo $opt3; ?>">
											</div>
											
											<div class="form-group">
											<label for="company" class=" form-control-label">Option 4</label>
											<input type="text" id="company" placeholder="Enter opt 4" class="form-control" name="opt4" value="<?php echo $opt4; ?>">
											</div>
											
											
											<div class="form-group">
											<label for="company" class=" form-control-label">Add answer</label>
											<input type="text" id="company" placeholder="answer" class="form-control" name="answer" value="<?php echo $answer;?>" >
											</div>
