							  ...
							  <div class="col-lg-6">
									...
									<div class="card">
										<div class="card-header"><strong>Add new questions</strong></div>
											...
											<label for="company" class=" form-control-label">Question</label><input type="text" id="company" placeholder="Enter question here" class="form-control" name="question">
											</div>
											
											<div class="form-group">
											<label for="company" class=" form-control-label">Option 1</label><input type="text" id="company" placeholder="Enter opt 1" class="form-control" name="opt1">
											</div>
											
											<div class="form-group">
											<label for="company" class=" form-control-label">Option 2</label><input type="text" id="company" placeholder="Enter opt 2" class="form-control" name="opt2">
											</div>
											
											<div class="form-group">
											<label for="company" class=" form-control-label">Option 3</label><input type="text" id="company" placeholder="Enter opt 3" class="form-control" name="opt3">
											</div>
											
											<div class="form-group">
											<label for="company" class=" form-control-label">Option 4</label><input type="text" id="company" placeholder="Enter opt 4" class="form-control" name="opt4">
											</div>
											
											
											<div class="form-group">
											<label for="company" class=" form-control-label">Add answer</label><input type="text" id="company" placeholder="answer" class="form-control" name="answer">
											</div>
											
											<div class="form-group">
											<input type="submit" name="submit1" value="Confirm" class="btn btn-success"/>
											</div>
					...
					<div class="col-lg-6">
									...
									<div class="card">
										<div class="card-header"><strong>Add new questions with images</strong></div>
											...
											<div class="form-group">
											<label for="company" class=" form-control-label">Question</label><input type="text" id="company" placeholder="Enter question here" class="form-control" name="fquestion">
											</div>
											
											<div class="form-group">
											<label for="company" class=" form-control-label">Option 1</label><input type="file"  class="form-control" name="fopt1">
											</div>
											
											<div class="form-group">
											<label for="company" class=" form-control-label">Option 2</label><input type="file"  class="form-control" name="fopt2">
											</div>
											
											<div class="form-group">
											<label for="company" class=" form-control-label">Option 3</label><input type="file" class="form-control" name="fopt3">
											</div>
											
											<div class="form-group">
											<label for="company" class=" form-control-label">Option 4</label><input type="file"  class="form-control" name="fopt4">
											</div>
											
											
											<div class="form-group">
											<label for="company" class=" form-control-label">Add answer</label><input type="file" class="form-control" name="fanswer">
											</div>
											
											<div class="form-group">
											<input type="submit" name="submit2" value="Confirm" class="btn btn-success"/>
											</div>
